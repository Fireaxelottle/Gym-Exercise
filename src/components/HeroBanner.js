...
const HeroBanner = () => {
  ...
  return (
    <div className='hero-banner-container'>
      ...
      <button className={css`background-color: #ff2625; color: white; border: none; padding: 10px 20px; border-radius: 5px; font-size: 1rem; font-weight: 600; cursor: pointer; margin-top: 50px `}>Explore Exercises</button>
